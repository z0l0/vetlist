...
def fix_juno_hours():
    """Fix hours for ALL Juno Veterinary locations"""
    
    # Read the CSV file
    rows = []
    with open('data/professionals.csv', 'r', encoding='utf-8') as file:
    ...
    # Write back to CSV
    with open('data/professionals.csv', 'w', encoding='utf-8', newline='') as file:
        writer = csv.DictWriter(file, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerows(rows)
    
    print("✅ Fixed hours for all Juno Veterinary locations")
